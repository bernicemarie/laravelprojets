...
class MarksController extends Controller
{
    ...
    public function MarksEditGetStudents(Request $request){
        ...
        $getStudent = StudentMarks::with(['registration_relation_user'])->where('year_id',$year_id)->where('class_id',$class_id)->where('assign_subject_id',$assign_subject_id)->where('exam_type_id',$exam_type_id)->get();
