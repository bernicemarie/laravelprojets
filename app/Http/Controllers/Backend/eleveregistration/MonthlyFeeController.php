...
class MonthlyFeeController extends Controller
{
   ...
   return view('backend.student_monthly.monthly_fee_view',$data);
    }
...
public function MonthlyFeeClassData(Request $request){
         ...
         foreach ($allStudent as $key => $v) {
            ...
            $html[$key]['tdsource'] .='<a class="btn btn-sm btn-'.$color.'" title="PaySlip" target="_blanks" href="'.route("monthly.fee.payslip").'?class_id='.$v->class_id.'&student_id='.$v->student_id.'&month='.$request->month.' ">Imprimer</a>';
            $html[$key]['tdsource'] .= '</td>';
    ...
    $pdf = PDF::loadView('backend.student_monthly.monthly_fee_pdf', $data);
