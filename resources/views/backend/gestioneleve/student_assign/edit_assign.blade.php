		 ...
		 <!-- Basic Forms -->
		  <div class="box">
			<div class="box-header with-border">
			  <h4 class="box-title">Editer des notes</h4>
			...
			<div class="box-body">
			  <div class="row">
				<div class="col">
					<form method="post" action="{{route('assign.update',$assignData[0]->class_id)}}">
						@csrf
					  <div class="row">
						<div class="col-12">						
							 <div class="add_item">
							 	@foreach($assignData as $edit)
		            <div class="delete_whole_extra_item_add" id="delete_whole_extra_item_add">
								...
								<div class="controls">
									<select name="class_id"  id="select" required class="form-control">
										...
										<option  value="{{$classe->id}}"{{($assignData['0']->class_id == $classe->id?"selected":"")}}>{{$classe->name}}</option>
										 @endforeach
									</select>
							...
							<div class="col-md-5">
								...
								<div class="controls">
									<select name="subject_id[]"  id="select" required  class="form-control">
										...
										<option value="{{$subjects->id}} " {{($edit->subject_id==$subjects->id)? "selected":""}}>{{$subjects->name}}</option>
