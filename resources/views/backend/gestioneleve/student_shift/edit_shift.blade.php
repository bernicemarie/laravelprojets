		 ...
		 <!-- Basic Forms -->
		  <div class="box">
			<div class="box-header with-border">
			  <h4 class="box-title">Editer un shift</h4>
			...
			<div class="box-body">
			  <div class="row">
				<div class="col">
					<form method="post" action="{{route('shift.update',$shiftData->id)}}">
						@csrf
					  <div class="row">
						<div class="col-12">						
							...
							<div class="form-group">
								...
								<div class="controls">
								<input value="{{$shiftData->name}}"  type="text" name="name" class="form-control">
								@error('name')
