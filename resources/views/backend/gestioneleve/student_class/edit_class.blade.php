		 ...
		 <!-- Basic Forms -->
		  <div class="box">
			<div class="box-header with-border">
			  <h4 class="box-title">Editer une classe</h4>
			...
			<div class="box-body">
			  <div class="row">
				<div class="col">
					<form method="post" action="{{route('classe.update',$classData->id)}}">
						@csrf
					  <div class="row">
						<div class="col-12">						
							...
							<div class="form-group">
								...
								<div class="controls">
								<input value="{{$classData->name}}"  type="text" name="name" class="form-control">
								@error('name')
