...
<div class="box bb-3 border-warning">
				  <div class="box-header">
					<h4 class="box-title">Elève<strong>Roll Generateur</strong></h4>
				  </div>
...
<div class="col-md-4">
 ...
 <div class="row d-none" id="roll-generate">
  ...
  <input type="submit" class="btn btn-info" value="Générateur">
     ...
     $.ajax({
      ...
      success: function (data) {
        ...
        $.each( data, function(key, v){
          html +=
          '<tr>'+
          '<td>'+v.registration_relation_user.id_no+'<input type="hidden" name="student_id[]" value="'+v.student_id+'"></td>'+
