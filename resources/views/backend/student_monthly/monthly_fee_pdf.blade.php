...
$originalfee = $registrationfee->amount;
        $discount = $details['registration_relation_discount']['discount'];
...
<table id="customers">
  ...
  <tr>
    <td>5</td>
    <td><b>Session</b></td>
    <td>{{ $details['registration_relation_year']['name'] }}</td>
  </tr>
  <tr>
    <td>6</td>
    <td><b>Class </b></td>
    <td>{{ $details['registration_relation_class']['name'] }}</td>
  </tr>
  <tr>
    <td>7</td>
...
<table id="customers">
  ...
  <tr>
    <td>5</td>
    <td><b>Session</b></td>
    <td>{{ $details['registration_relation_user_year']['name'] }}</td>
  </tr>
  <tr>
    <td>6</td>
    <td><b>Class </b></td>
