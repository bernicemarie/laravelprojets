...
<div class="form-group">
	 ...
	 <input type="file" name="image" class="form-control" id="image" >  </div>
 		 ...
 		 <div class="form-group">
		<div class="controls">
	<img id="showImage" src="{{ (!empty($editData->image))? url('upload_image/cost_images/'.$editData->image):url('upload_image/bernice.jpg') }}" style="width: 70px; height: 50px;"> 
 	...
 	<div class="form-group">
		 <h5>Description <span class="text-danger">*</span></h5>
				<div class="controls">
		 <textarea cols="10" rows="20" name="description" id="description" class="form-control" required="" placeholder="Entrer votre texte" aria-invalid="false">{{ $editData->description }}</textarea>
	 ...
	 <input type="submit" class="btn btn-rounded btn-primary mb-5" value="Envoyer">
