...
<p> <b> Situation employé</b> </p>
 ...
 <br> <br>
 <strong>Nom: </strong> {{ $allData['0']['relation_user']['name'] }}, <strong> ID No : </strong>{{ $allData['0']['relation_user']['id_no'] }}, <strong> Mois : </strong> {{ $month }}
 <br> <br>
<table id="customers">
...
@foreach($allData as $value)
  ...
  <tr>
    <td colspan="2">
      <strong>Total Absence : </strong> {{ $absents }} , <strong> Total Leave : </strong> {{ $leaves }}
