...
<div class="box bb-3 border-warning">
  ...
  <div class="row">  <!-- start 1st row -->
   ...
   <img src="{{ url('upload_image/bernice.jpg') }}" style="width: 120px; height: 100px;">			
  		</div>
        ...
        <div class="col-md-2 text-center">
  		...
  		<div class="col-md-4 text-center" style="float: left;">
  			<h4><strong>Ecole Mama Thérèse</strong></h4>
  			<h6><strong></strong></h6>
  			<h5><strong><u><i>Travail-Rigueur-Réussite</i></u></strong></h5>
...
@php
	$assign_student = App\Models\StudentRegistration::where('year_id',$allMarks['0']->year_id)->where('class_id',$allMarks['0']->class_id)->first();
@endphp
...
<tr>
	<td width="50%">Name </td>
	<td width="50%">{{ $allMarks['0']['registration_relation_user']['name'] }}</td>
</tr>
