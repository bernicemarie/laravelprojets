	...
	<a href="{{ route('marks.grade.add') }}" style="float: right;" class="btn btn-rounded btn-success mb-5"> Add Grade Marks</a>			  
		...
		<tbody>
			...
			<tr>
				...
				<td>
<a id="edit" href="{{ route('marks.grade.edit',$value->id) }}" class="btn btn-primary"><i class="fa fa-edit"></i></a>
<a id="delete" href="{{ route('delete.marks.grade',$value->id) }}" class="btn btn-danger"><i class="fa fa-trash-o"></i></a>
